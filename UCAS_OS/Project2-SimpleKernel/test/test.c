...
// (2) sys_move_cursor()
// (3) sys_write()
struct task_info task2_6 = {(ptr_t)&sleep_task, USER_PROCESS,50};
struct task_info task2_7 = {(ptr_t)&timer_task, USER_PROCESS,50};
struct task_info *timer_tasks[16] = {&task2_6, &task2_7};
int num_timer_tasks = 2;

struct task_info task2_8 = {(ptr_t)&print_task1, USER_PROCESS ,20};
struct task_info task2_9 = {(ptr_t)&print_task2, USER_PROCESS ,70};
struct task_info task2_10 = {(ptr_t)&drawing_task, USER_PROCESS,100};
struct task_info *sched2_tasks[16] = {&task2_8, &task2_9, &task2_10};
int num_sched2_tasks = 3;

struct task_info task2_11 = {(ptr_t)&lock_task1, USER_THREAD,80};
struct task_info task2_12 = {(ptr_t)&lock_task2, USER_THREAD,40};
struct task_info *lock2_tasks[16] = {&task2_11, &task2_12};
int num_lock2_tasks = 2;

struct task_info task2_13 = {(ptr_t)&fork_task, USER_THREAD,1};
